...
INSERT INTO "new_Reply" ("body", "bodyHtml", "createdAt", "createdById", "deleted", "deletedAt", "id", "threadId", "title", "updatedAt") SELECT "body", "bodyHtml", "createdAt", "createdById", "deleted", "deletedAt", "id", "threadId", "title", "updatedAt" FROM "Reply";
DROP TABLE "Reply";
...
INSERT INTO "new_Thread" ("body", "bodyHtml", "createdAt", "createdById", "deleted", "deletedAt", "id", "title", "topicId", "updatedAt") SELECT "body", "bodyHtml", "createdAt", "createdById", "deleted", "deletedAt", "id", "title", "topicId", "updatedAt" FROM "Thread";
DROP TABLE "Thread";
