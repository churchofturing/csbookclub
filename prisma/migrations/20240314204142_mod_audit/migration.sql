/*
  ...
  - You are about to drop the column `deleted` on the `Topic` table. All the data in the column will be lost.
  - You are about to drop the column `deletedAt` on the `Topic` table. All the data in the column will be lost.
  - You are about to drop the column `deleted` on the `Thread` table. All the data in the column will be lost.
  - You are about to drop the column `deletedAt` on the `Thread` table. All the data in the column will be lost.
