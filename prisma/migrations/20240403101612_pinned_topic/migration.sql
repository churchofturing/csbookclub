...
INSERT INTO "new_Topic" ("body", "bodyHtml", "createdAt", "createdById", "id", "lastBumped", "slug", "title", "topicCount", "updatedAt") SELECT "body", "bodyHtml", "createdAt", "createdById", "id", "lastBumped", "slug", "title", "topicCount", "updatedAt" FROM "Topic";
DROP TABLE "Topic";
